...
iv = '0102030405060708'
param_b = '010001'
param_c = '00e0b509f6259df8642dbc35662901477df22677ec152b5ff68ace615bb7b725152b3ab17a' \
          '876aea8a5aa76d2e417629ec4ee341f56135fccf695280104e0312ecbda92557c93870114af6c9d05c4f7f0c' \
          '3685b7a46bee255932575cce10b424d813cfe4875d3e82047b97ddef52741d546b8e289dc6935b3ece0462db0a22b8e7'
...
encSecKey = '257348aecb5e556c066de214e531faadd1c55d814f9be95fd06d6bff9f4c7a41f831f6394d5a3fd2e3881736d' \
            '94a02ca919d952872e7d0a50ebfa1769a7a62d512f5f1ca21aec60bc3819a9c3ffca5eca9a0dba6d6f7249b06' \
            'f5965ecfff3695b54e1c28f3f624750ed39e7de08fc8493242e26dbc4484a01c76f739e135637c'
...
def get_params(x):
    ...
    if not x == 1:
        param_a = "{rid:\"R_SO_4_4153366\", offset:\"%s\", total:\"false\", limit:\"20\", " \
                  "csrf_token:\"\"}" % (str(x * 20 - 20))
    iv = "0102030405060708"
    first_key = param_d
    second_key = suiji16
